...
# 점수 초기화
score = 0
font = pygame.font.Font(None, 74)  # 폰트와 크기 설정
...
while running:
    ...
    # 생명 표시
    life_text = font.render(str(life), True, (255, 0, 0))
    screen.blit(life_text, (screen_width-50, 10))
